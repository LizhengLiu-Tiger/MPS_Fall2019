/*
 * Lab04_3.c Part2 (floating numbers)
 *
...
int main()
{
	...
	//Set 1: define the integer: r2 = 6, r3 = 7, do addition
	asm("LDR r2, =6");
	asm("LDR r3, =7");
	asm("ADD r4, r2, r3");
	...
	//Set 2: define the floating numbers: var1 = 97.33, var2 = 22.66, do multiplication
	var1 = 97.33;
	var2 = 22.66;
    ...
    //Set 3: floating invariable x and result: 2x/3+5
    x = 26;
    in_1 = 2;
    in_2 = 3;
    in_3 = 5;
